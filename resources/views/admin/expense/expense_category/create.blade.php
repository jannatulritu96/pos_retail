    ...
    <div class="page-content container-fluid">
        <div class="row justify-content-center">
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Expense category create form</h4>
                        <form method="post" class="form-horizontal" action="{{ route('expense_category.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="box-body">
                                <div class="form-group" style="margin-left: 5px;">
                                    ...
                                    <input id="cat_name" type="text" class="form-control @error('cat_name') is-invalid @enderror" name="cat_name" placeholder="Category name" value="{{ old('cat_name') }}"  style="width: 98%;">
                                    @error('cat_name')
