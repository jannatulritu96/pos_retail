                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('expense_category.create') }}" class="btn btn-primary" style="float: right;margin-bottom: 17px;">Create Expense Category</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <form method="get" class="form-horizontal" action="{{route('expense_category.index')}}" >
                                        ...
                                        <div id="default_order_filter" class="dataTables_filter" style="float: right;margin-right: 5px">
                                            <input type="text" class="form-control form-control-sm" name="cat_name" placeholder="Category"
                                                   value="{{Request::get('cat_name')}}" onchange="search_post()">
                                        </div>
...
@section('script')
    <script>
        function updateStatus(id) {
            ...
            $.ajax({
                type: 'post',
                url: 'expense_category/change-activity/'+ id,
                cache: false,
                data: data,
