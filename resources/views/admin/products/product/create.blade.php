                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group" style="margin-left: 5px;">
                                    <label for="purchase">Purchase Price (Tk)<span
                                            style="color: red">*</span></label>
                                    <input id="purchase" type="number" class="form-control @error('purchase') is-invalid @enderror" name="purchase" placeholder="Purchase Price" value="{{ old('purchase') }}"  style="width: 98%;">
                                    @error('purchase')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group" style="margin-left: 5px;">
                                    ...
                                    <input id="image"class="form-control" type="file"  name="image" style="width: 98%;">
                                    @error('image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
