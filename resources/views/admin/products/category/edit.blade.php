                        ...
                        <form method="post" class="form-horizontal" action="{{ route('category.update',$category) }}" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                <div class="form-group" style="margin-left: 5px;">
                                    ...
                                    <input id="category" type="text" class="form-control @error('category') is-invalid @enderror" name="category" placeholder="Category" value="{{ $category->category }}"  style="width: 98%;">
                                    @error('category')
