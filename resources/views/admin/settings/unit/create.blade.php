            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" class="form-horizontal" action="{{ route('unit.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="box-body">
                                <div class="form-group" style="margin-left: 5px;">
                                    ...
                                    <input id="unit" type="text" class="form-control @error('unit') is-invalid @enderror" name="unit" placeholder="Unit" value="{{ old('unit') }}"  style="width: 98%;">
                                    @error('unit')
